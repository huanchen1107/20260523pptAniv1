...
- **WHEN** the user executes `bash convert_images.sh` in the project root with `user/assets/images/logo.png` present,
...
- **WHEN** `convert_images.sh` encounters a file with an unsupported extension (e.g., `.txt`),
